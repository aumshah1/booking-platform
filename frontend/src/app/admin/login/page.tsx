...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md bg-card border-border text-card-foreground shadow-2xl relative pt-6">
        <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-primary p-3 rounded-full border-4 border-background shadow-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="px-6 pb-6 pt-2">
            <button 
              type="submit" 
              disabled={loading}
              className="w-full py-2.5 px-4 bg-primary hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed text-primary-foreground rounded-lg font-medium transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-2"
            >
